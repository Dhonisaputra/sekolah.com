...
class CI_DB_active_record extends CI_DB_driver {
	...
	var $ar_last_cache     		= array();

	// --------------------------------------------------------------------

	public function get_components($components_name=FALSE)
	{
		if(!$components_name)
		{
			return $this->ar_last_cache;
		}
		return $this->ar_last_cache['ar_'.$components_name];
	}
	public function unset_components($components_name)
	{
		unset($this->ar_last_cache['ar_'.$components_name]);
	}
	/**
	 * Select
	 *
	...
	{
		// add to latest ar_component before reset it.
		$components = $this->_list_components();
		$this->_reset_last_components();
		foreach ($components as $key => $value) {
			$this->ar_last_cache[$value] = $this->$value;
		}
	...
	protected function _list_components()
	{
		return array(
			'ar_select'			,
			'ar_from'			,
	...
	protected function _reset_last_components()
	{
		$this->ar_last_cache = [];
	}
}
